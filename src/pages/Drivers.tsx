        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          <div className="lg:col-span-2 space-y-4">
            <div className="glass-card p-6">
              <div className="flex items-center gap-4 mb-6">
                ...
                <div>
                  <h2 className="text-xl font-bold dark:text-white text-surface-900">{detail.fullName}</h2>
                  <p className="text-sm dark:text-gray-400 text-surface-500">{detail.id} — {detail.licenseNumber}</p>
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                <div className="dark:bg-navy-700/30 bg-surface-50 rounded-xl p-4">
                  <p className="text-xs dark:text-gray-400 text-surface-500">Safety Score</p>
                  <p className={`text-2xl font-bold ${getSafetyColor(detail.safetyScore)}`}>{detail.safetyScore}/100</p>
                </div>
                <div className="dark:bg-navy-700/30 bg-surface-50 rounded-xl p-4">
                  <p className="text-xs dark:text-gray-400 text-surface-500">Driving Hours</p>
                  <p className="text-2xl font-bold dark:text-white text-surface-900">{detail.drivingHours}h</p>
                </div>
                <div className="dark:bg-navy-700/30 bg-surface-50 rounded-xl p-4">
                  <p className="text-xs dark:text-gray-400 text-surface-500">Drowsiness Alerts</p>
                  <p className={`text-2xl font-bold ${detail.drowsinessAlerts > 0 ? 'text-red-400' : 'text-emerald-400'}`}>{detail.drowsinessAlerts}</p>
                </div>
                <div className="dark:bg-navy-700/30 bg-surface-50 rounded-xl p-4">
                  <p className="text-xs dark:text-gray-400 text-surface-500">SOS Events</p>
            ...
            <div className="glass-card p-6">
              <h3 className="text-sm font-bold dark:text-white text-surface-900 mb-4">Safety Breakdown</h3>
                ...
                {[
                  ...
                  <div key={item.label}>
                    <div className="flex justify-between text-xs mb-1">
                      <span className="dark:text-gray-400 text-surface-500">{item.label}</span>
                      <span className="dark:text-white text-surface-900">{item.value}</span>
                    </div>
          ...
          <div className="space-y-4">
            <div className="glass-card p-4">
              <h3 className="text-sm font-bold dark:text-white text-surface-900 mb-3">Contact Info</h3>
              <div className="space-y-2 text-xs">
                <div className="flex items-center gap-2"><Phone className="w-3.5 h-3.5 dark:text-gray-400 text-surface-500" /><span className="dark:text-white text-surface-900">{detail.phone}</span></div>
                <div className="flex items-center gap-2"><Phone className="w-3.5 h-3.5 text-red-400" /><span className="dark:text-white text-surface-900">{detail.emergencyContact}</span></div>
              </div>
            </div>
            <div className="glass-card p-4">
              <h3 className="text-sm font-bold dark:text-white text-surface-900 mb-3">Current Assignment</h3>
              <div className="space-y-2 text-xs">
                <div className="flex justify-between"><span className="dark:text-gray-400 text-surface-500">Vehicle</span><span className="dark:text-white text-surface-900">{detail.assignedVehicle}</span></div>
                ...
                <div className="flex justify-between"><span className="dark:text-gray-400 text-surface-500">License Exp</span><span className="dark:text-white text-surface-900">{detail.licenseExpiry}</span></div>
              </div>
            </div>
            <div className="glass-card p-4">
              <h3 className="text-sm font-bold dark:text-white text-surface-900 mb-3">AI Monitoring Status</h3>
              <div className="space-y-2 text-xs">
                <div className="flex justify-between"><span className="dark:text-gray-400 text-surface-500">Eye Status</span><span className="text-emerald-400">{detail.eyeStatus}</span></div>
                <div className="flex justify-between"><span className="dark:text-gray-400 text-surface-500">Attention</span><span className="text-emerald-400">{detail.attention}</span></div>
              </div>
            </div>
          </div>
        </div>
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
        {filtered.map((d) => (
          <div key={d.id} onClick={() => setSelectedDetail(d.id)} className="glass-card p-4 dark:hover:bg-white/5 hover:bg-surface-50 cursor-pointer transition-all group">
            <div className="flex items-start justify-between mb-3">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="text-sm font-bold dark:text-white text-surface-900 group-hover:text-electric-400 transition-colors">{d.fullName}</h3>
                  <p className="text-[10px] dark:text-gray-400 text-surface-500">{d.id}</p>
                </div>
              </div>
            ...
            <div className="space-y-2 text-xs">
              <div className="flex justify-between">
                <span className="dark:text-gray-400 text-surface-500">Safety Score</span>
              ...
              <div className="flex justify-between">
                ...
                <span className="dark:text-white text-surface-900">{d.assignedVehicle}</span>
              </div>
              <div className="flex justify-between">
                <span className="dark:text-gray-400 text-surface-500">Drowsiness</span>
                <span className={`dark:text-white text-surface-900 ${d.drowsinessAlerts > 0 ? 'text-red-400' : ''}`}>{d.drowsinessAlerts} alerts</span>
              </div>
              <div className="flex justify-between">
                <span className="dark:text-gray-400 text-surface-500">Driving Hours</span>
                <span className="dark:text-white text-surface-900">{d.drivingHours}h</span>
              </div>
            </div>
