    ...
    <div className="glass-card p-4 space-y-4">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-2">
          ...
          <h4 className="text-xs font-bold text-white">{vehicleId}</h4>
        </div>
        <span className="text-[10px] text-gray-400">Capacity: {capacity}</span>
      </div>

      <div>
        <div className="flex items-center justify-between mb-1">
          <span className="text-[10px] text-gray-400">Current Occupancy</span>
          <span className="text-xs font-bold text-white">{occupancy} / {capacity}</span>
        </div>
      ...
      <div className="grid grid-cols-5 gap-2">
        ...
        <div className="text-center p-2 bg-purple-500/10 rounded-lg">
          ...
          <p className="text-[8px] text-gray-400">Dropped</p>
        </div>
      </div>
